...
const Navbar = () => {
  ...
  const NavLink = ({
    ...
    <Link
      ...
      className="text-green-900 hover:text-green-900 px-3 py-2 text-base font-medium rounded-md hover:bg-gray-50"
    >
      {children}
    </Link>
  );
  ...
  return (
    <header
      className={`fixed top-0 w-full z-50 transition-all duration-300 bg-white shadow-sm ${scrolled ? "shadow-md" : ""}`}
    >
