...
const Navbar = () => {
  ...
  return (
    <header className={`fixed top-0 w-full z-50 transition-all duration-300 bg-white shadow-sm ${scrolled ? 'shadow-md' : ''}`}>
      <div className=" px-4 sm:px-10 lg:px-20">
        <div className="flex justify-between items-center h-16">
          {/* Logo */}
          <Link to="/" className="flex items-center space-x-2">
            <svg width="31" height="31" fill="none" viewBox="0 0 31 31">   <g clip-path="url(#clip0_46_27)">
    ...
    <path d="M24.0211 8.9186L26.8146 8.49458L27.0702 8.89034L25.5369 11.2655L25.2653 10.8449L26.675 8.74678L26.7789 8.90755L24.2886 9.333L24.021 8.91872L24.0211 8.9186ZM24.8116 9.04339L25.1969 8.94793L25.9518 10.1167L25.7064 10.4286L24.8117 9.04339H24.8116Z" fill="#005C03"/>
            ...
            <span className="text-2xl font-bold text-green-900">JustMatcha</span>
          </Link>
          ...
          <div className="flex items-center space-x-2">
            ...
            {isAuthenticated ? (
              <>
                <button onClick={() => navigate('/account')} className="p-2 text-green-900">
